...
from src.domain.category.repositories.create_category_repository_abstract import CreateCategoryRepositoryAbstract
...
class CreateCategoryCommand(CreateCategoryCommandAbstract):
    ...
    def __init__(self, repo: CreateCategoryRepositoryAbstract, event: EventCategoryPublisherAbstract):        
        self.repo = repo
        self.event = event
